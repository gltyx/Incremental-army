...
var cnItems = {
    ...
    "Charlie-03: Reach Max Approval": "Charlie-03：达到最大批准",
    ...
    "never gonna give you a rickroll": "永远不会给你一个rickroll",
...
var cnPrefix = {
    ...
    "Sergeant: ": "中士：",
    "Staff Sergeant: ": "参谋长：",
    "Rewards: Medals: +0.00 | Approval: +0.00 | Morale +/-0.00": "奖励：勋章：+0.00 |批准：+0.00 |士气 +/-0.00",
...
var cnRegReplace = new Map([
    ...
    [/^Hire (.+) 1st Lt \| Cost: (.+) Medal$/, '雇佣 $1 1st Lt \| 成本：$2 勋章'],
    [/^Hire (.+) 1st Lt \| Cost: (.+) Medals$/, '雇佣 $1 1st Lt \| 成本：$2 勋章'],
    [/^Hire (.+) 2nd Lt \| Cost: (.+) Medal$/, '雇佣 $1 2nd Lt \| 成本：$2 勋章'],
    [/^Hire (.+) 2nd Lt \| Cost: (.+) Medals$/, '雇佣 $1 2nd Lt \| 成本：$2 勋章'],
    ...
    [/^Enlist (.+) Pvt \| Cost: (.+) Infantry Equipment$/, '征募 $1 PVT \| 成本：$2 步兵装备'],
    [/^Enlist (.+) SSGT \| Cost: (.+) Infantry Equipment$/, '征募 $1 SSGT \| 成本：$2 步兵装备'],
    [/^Enlist (.+) SSgt \| Cost: (.+) Infantry Equipment$/, '征募 $1 SSGT \| 成本：$2 步兵装备'],
    [/^Enlist (.+) SGT \| Cost: (.+) Infantry Equipment$/, '征募 $1 SGT \| 成本：$2 步兵装备'],
    [/^Enlist (.+) Sgt \| Cost: (.+) Infantry Equipment$/, '征募 $1 SGT \| 成本：$2 步兵装备'],
    [/^Acquire Funding \((.+) \| (.+) Approval\)$/, '获得资金（$1 \| $2 批准）'],
    ...
    [/^Rewards: (.+) Medals \| (.+) Approval$/, '奖励：$1 勋章 \| $2 批准'],
