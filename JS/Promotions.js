...
const promotionDescs = ['Automated Enlistment','Propaganda only Costs 50% of Funds','Automated Fabrication','Automated Acquisition','Medal Gain 2x','Automated Hiring','Propaganda only costs 25% of Funds','5x Base Funding','Automated Funding',
'Medal Gain 4x','Decrease Cost Scaling on Enlisted','','Being Researched','Being Researched','Being Researched']
